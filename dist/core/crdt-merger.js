...
class CrdtMerger {
     ...
     */
    static merge(local, remote, schema, remoteIsNewer) {
        const result = {};
        ...
        for (const field of allFields) {
            const strategy = schema[field] ?? 'lww';
     ...
     */
    static preview(local, remote, schema, remoteIsNewer) {
        const merged = {};
...
exports.CrdtMerger = CrdtMerger;
// ─── Strategy implementations ─────────────────────────────────────────────────
function applyStrategy(local, remote, strategy, remoteIsNewer) {
    switch (strategy) {
        case 'lww':
            if (remote === undefined)
                return local;
...
//# sourceMappingURL=crdt-merger.js.map